...
const Internship = () => {
    return (
    <div name="experience" className=' flex w-full h-fit bg-gradient-to-b  from-cyan-500 via-purple-500 to-pink-500 text-white py-40 '>
        <div className='max-w-screen-lg mx-auto flex flex-col items-start justify-start h-full px-4 lg:flex-row'>
            <div className='flex flex-col items-start justify-start'>
                ...
                <p className='text-justify text-xl py-6 max-w-md'>
                ...
                <img src={require('../assets/msu-logo.png')}  alt="Michigan State University" className=' h-72 w-72 lg:ml-24 mt-14' />
            </div>
