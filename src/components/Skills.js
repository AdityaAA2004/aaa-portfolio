...
function Experience() {
  ...
  return (
<div name="skills" className='bg-gradient-to-b from-gray-800 via-blue-950 to-black w-screen text-white lg:max-h-fit mb-10'>
        <div className=' max-w-screen-lg p-4 mx-auto flex flex-col justify-start w-full h-full mb-15'>
            <div className='pb-8'>
                ...
                <p className='py-8 text-lg'>These are some skills I have acquired through my journey in Computer Science</p>
            </div>
            <div className='grid grid-cols-1 md:grid-cols-3 gap-8 px-12 sm:px-0'>
                
                {skills.map(({id,skillName,skillLogo,shadeColor,textColor},ind)=>
                (   
                    ...
                    <div className='flex items-center justify-center'>
                        <span className={`w-1/2 px-6 py-3 m-4 text-center text-white`}>{skillName}</span>
                    </div>
                </div>  
